...
import se.pj.tbike.http.model.product.ProductMapper;
import se.pj.tbike.http.model.product.ProductListRequest;
import se.pj.tbike.http.model.product.ProductRequest;
import se.pj.tbike.domain.entity.Product;
import se.pj.tbike.domain.service.ProductService;
import se.pj.tbike.http.model.product.ProductResponse;
import se.pj.tbike.http.model.product.ProductDetail;
